...
export function Sidebar({ open, setOpen }: IProps) {
  ...
  return (
    <aside
      className={`absolute transition-all top-0 w-[160px] transform h-full flex flex-col bg-white shadow-xl border-r border-gray-200 pt-10 ${openStyles}`}
    >
