...
export const Layout: React.FC<IProps> = ({ children }) => {
  ...
  function handleCloseSidebarOnClickAway(
  ...
  return (
    <div className="text-sm font-sans w-full h-screen flex justify-center items-center bg-gray-200">
      <div className="w-full min-h-[600px] max-w-[335px] flex flex-col mx-auto bg-black border-4 border-black rounded-md shadow-md overflow-hidden">
        <header className="text-[13px] text-[15px] bg-black h-[25px] text-white flex gap-2 justify-between items-center px-2">
          <div className="flex gap-2 items-center">
            <span className="flex items-center text-[11px] h-[14px]">
              20:28
            </span>
            <FiCloud />
          </div>
        ...
        <div className="relative bg-white">
          ...
          >
            ...
            <div className="w-[40px] h-[40px] overflow-hidden bg-gray-400 rounded-full">
              <img
